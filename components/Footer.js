const Footer = () => {
    return(
        <footer className="footer mt-auto items-center p-4 bg-red-400 text-neutral-content">
            ...
            <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                <a href="www.linkedin.com/in/sviatoslav-nakonechniy-b0a066227">
                    <img width={24} height={24} src="/linkedin.png" alt="LinkedIn"/>
                </a>
                <a href="https://github.com/lolohandri">
                    <img width={24} height={24} src="/github%20(1).png" alt="GitHub"/>
                </a>
                <a href="https://www.instagram.com">
                    <img width={24} height={24} src="/instagram.png" alt="Instagram"/>
                </a>
            </nav>
        </footer>
    )
